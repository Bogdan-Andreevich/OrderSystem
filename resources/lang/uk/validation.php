...
return [
    ...
    "accepted_if" =>
        "Поле :attribute має бути прийнятним, коли :other є :value.",
    ...
    "alpha_dash" =>
        "Поле :attribute має містити лише літери, цифри, тире та підкреслення.",
    ...
    "are_you_sure_you_want_to_delete_team" =>
        "Ви впевнені, що хочете видалити цю команду?",
    "are_you_sure_you_want_to_leave_team" =>
        "Ви впевнені, що хочете залишити цю команду?",
    "array" => "Поле :attribute має бути масивом.",
    "ascii" =>
        "Поле :attribute має містити лише однобайтові буквено-цифрові знаки та символи.",
    ...
    "declined_if" =>
        "Поле :attribute має бути відхилено, якщо :other є :value.",
    ...
    "doesnt_end_with" =>
        "Поле :attribute не може закінчуватися одним із таких: :values.",
    "doesnt_start_with" =>
        "Поле :attribute не може починатися з одного з наступного: :values.",
    "edit_team_member" => "Редагувати члена команди",
    "email" => "Поле :attribute повинне містити коректну електронну адресу.",
    "ends_with" =>
        "Поле :attribute має закінчуватися одним з наступних значень: :values",
    ...
    "if_you_delete_team_all_data_will_be_deleted" =>
        "Якщо ви вирішите видалити команду, усі дані буде остаточно видалено.",
    ...
    "looks_like_you_are_not_part_of_team" =>
        "Схоже, ви не є частиною жодної команди!",
    ...
    "missing_if" =>
        "Поле :attribute має бути відсутнім, якщо :other дорівнює :value.",
    "missing_unless" =>
        "Поле :attribute має бути відсутнім, якщо :other не є :value.",
    "missing_with" =>
        "Поле :attribute повинно бути відсутнім, якщо присутнє :values.",
    "missing_with_all" =>
        "Поле :attribute повинно бути відсутнім, якщо присутні :values.",
    "multiple_of" => "Поле :attribute повинно бути кратним :value",
    "next" => "Далі &raquo;",
    "not_eligible_based_on_current_members_teams" =>
        "Ви не маєте права на цей план через поточну кількість команд/членів команди.",
    ...
    "plan_allows_no_more_teams" =>
        "Ваш поточний план не дозволяє створювати більше команд",
    "please_upgrade_to_add_more_members" =>
        "Оновіть свою підписку, щоб додати більше учасників команди.",
    "please_upgrade_to_create_more_teams" =>
        "Оновіть свою підписку, щоб створити більше команд.",
    "present" => "Поле :attribute повинне бути присутнє.",
    "previous" => "&laquo; Назад",
    "prohibited" => "Поле :attribute заборонено.",
    "prohibited_if" =>
        "Поле :attribute заборонено, коли :other дорівнює :value.",
    "prohibited_unless" =>
        "Поле :attribute заборонено, якщо тільки :other не знаходиться в :values.",
    ...
    "required_if_accepted" =>
        "Поле :attribute є обов'язковим, якщо прийнято :other.",
    "required_unless" =>
    ...
    "sent" =>
        "Ми надіслали на Вашу електронну адресу посилання для зміни пароля!",
    ...
    "slug_input_explanation" =>
        "Цей слаг використовується для ідентифікації вашої команди в URL-адресах.",
    "starts_with" =>
        "Поле :attribute повинне починатися з одного з наступних значень: :values",
    ...
    "team_trial_will_expire_on" =>
        "Випробувальний період команди закінчиться :date.",
    "teams" => "Команди",
    "teams_currently_trialing" => "Команди, які зараз проходять випробування",
    "throttle" =>
        "Забагато спроб входу. Будь ласка, спробуйте ще раз, через :seconds секунд.",
    ...
    "user_already_invited_to_team" =>
        "Цього користувача вже запрошено до команди.",
    ...
    "user_invited_to_join_team" =>
        ":UserName запросив вас приєднатися до своєї команди!",
    ...
    "we_found_invitation_to_team" =>
        "Ми знайшли ваше запрошення в команду :teamName!",
    "wheres_your_team" => "Де ваша команда?",
    "you_have_been_invited_to_join_team" =>
        "Вас запросили приєднатися до команди :teamName!",
    "you_have_x_invitations_remaining" =>
        "Наразі у вас залишилося :count запрошень.",
